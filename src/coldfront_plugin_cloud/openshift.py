...
QUOTA_KEY_MAPPING = {
    ...
    attributes.QUOTA_REQUESTS_VM_GPU_A100_SXM4: lambda x: {":requests.nvidia.com/A100_SXM4_40GB": f"{x}"}, # TODO: Confirm these are the correct resource names on Openshift
