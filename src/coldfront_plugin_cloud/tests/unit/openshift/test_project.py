...
class TestOpenshiftQuota(base.TestUnitOpenshiftBase):
    def test_get_project(self):
        ...
        self.allocator.k8_client.resources.get.return_value.get.return_value = fake_project
        res = self.allocator._get_project("fake-project")
        assert res == {"project": "fake-project"}

    @mock.patch("coldfront_plugin_cloud.openshift.OpenShiftResourceAllocator._openshift_create_limits", mock.Mock())
    ...
    def test_delete_project(self):
        ...
        self.allocator.k8_client.resources.get.return_value.delete.assert_called_with(name="fake-project")
